...
{
    class CurrencyDataMock : ICurrencyService
    {
        private readonly CurrencyDataModel _currencyDataModel;

        public CurrencyDataMock()
        {
            ...
            _currencyDataModel = new CurrencyDataModel
            {
                CurrencyListModel = currencyListModel,
                CurrencyQuotesModel = currencyQuotesModel,
